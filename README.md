...
Employees can enter their hours worked for the week as well as PTO hours. The program then calculates their gross pay, each itemized deduction, and their net pay based off personalized information for each person.
...
All of the supporting documents for this project including the project plan, blank test cases, completed test cases, <ins> [User Guide](./Supplemental_Information/User%20Guide.docx) </ins>, and UML documentation are located in the folder titled ***Supporting Documentation***.
